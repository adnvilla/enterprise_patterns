...
Un objeto-puerta por fila: cada `OrderRowGateway` representa exactamente un registro de `orders`, carga sus columnas como campos y sabe actualizar o borrar su propia fila, sin lógica de negocio. Parte de la serie [«Patrones de Arquitectura de Aplicaciones Empresariales»](https://adrianvillafana.com/?p=951) — entrada: [Table Data Gateway y Row Data Gateway](https://adrianvillafana.com/?p=960).
